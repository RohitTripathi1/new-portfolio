          ...
          {educationData.map((edu, index) => (
            <div key={index} className="card relative pl-8" style={{ borderLeft: '4px solid #569cd6' }}>
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                <div>
                  <h3 className="text-2xl font-semibold mb-2" style={{ color: '#dcdcaa', fontFamily: "'JetBrains Mono', monospace" }}>
                  ...
                  <div className="flex items-center mb-4" style={{ fontWeight: 400, color: '#858585', fontFamily: "'JetBrains Mono', monospace" }}>
                ...
                <div className="flex items-center px-4 py-2 rounded-lg" style={{ fontWeight: 500, color: '#9cdcfe', background: '#264f78', border: '1px solid #3e3e42', fontFamily: "'JetBrains Mono', monospace" }}>
