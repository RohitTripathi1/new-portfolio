      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            <p className="text-sm sm:text-base md:text-lg leading-relaxed" style={{ fontWeight: 400, color: '#d4d4d4', fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          <div className="relative">
            <div style={{ background: '#252526', border: '1px solid #3e3e42', borderRadius: '0.5rem', padding: '2rem', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.3)' }}>
              <div className="relative">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-4 break-words" style={{ color: '#dcdcaa', fontFamily: "'JetBrains Mono', monospace" }}>
              ...
              <ul className="space-y-2 text-xs sm:text-sm md:text-base" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((highlight, index) => (
            ...
            >
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-2 break-words" style={{ color: '#dcdcaa', fontFamily: "'JetBrains Mono', monospace" }}>
              ...
              <p style={{ fontWeight: 400, lineHeight: '1.6', color: '#d4d4d4', fontFamily: "'JetBrains Mono', monospace", fontSize: '0.75rem', wordBreak: 'break-word', overflowWrap: 'break-word' }} className="sm:text-xs md:text-sm">
